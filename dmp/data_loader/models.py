...
class DataSource(models.Model):
    ...
    def process_data(self, fname):
        ...
        return call(". {embulk_path}.bashrc;. {embulk_path}.rvm/scripts/rvm; {embulk_path}.embulk/bin/embulk gem list".format(embulk_path=settings.EMBULK_USER_PATH), shell=True, stdout=log_file)
